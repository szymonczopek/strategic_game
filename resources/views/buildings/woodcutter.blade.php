    ...
    <div class="board">
        ...
        <div class="build">
            <div class="buildInfo1">
                <div class="buildTitle">Drwal - Poziom {{$level}}</div>
                <img src="https://cdn.imageupload.workers.dev/rZxt18DW_drwal-wyciety.png">
                <div class="buildBack">
                    <div class="building">
                        <div>
                            <a href="">
                            ...
                            <div>
                                Tępo zdobywania drewna na {{$level+1}} poziomie:&nbsp+{{$forestRatio+$bonusUpgrade}}/h </br>
                                Wymagania:</br>
                                Drewno: {{$woodNeed}}</br>
                                Kamień: {{$stoneNeed}}</br>
            ...
            <div class="buildInfo2">
              <div class="buildInfo">
                <h1> Drwal</h1>
                  <div>
                      Każdy kolejny poziom drwala zwiększa wydobycie drewna przez populacje w czasie godziny.
                ...
                <div class="mainInfo">
                 <h1> Dane drwala</h1>
                    <div>
                        <div class="infoLine"> <div class="iconWork"><img src="https://cdn-icons-png.flaticon.com/512/2077/2077113.png"></div>Aktualne tępo wydobycia drewna:&nbsp+{{$forestRatio}}/h</div>
