        ...
        <div class="build">
                ...
                <div class="buildBack">
                    <div class="building">
                        <div>
                            ...
                            <div>
                                Zniżka kosztów budowy na {{$level+1}} poziomie:&nbsp-{{$bonus+$bonusUpgrade}}% </br>
                                Wymagania:</br>
                                Drewno: {{$woodNeed}}</br>
                                Kamień: {{$stoneNeed}}</br>
            ...
            <div class="buildInfo2">
              <div class="buildInfo">
                <h1>Architekt</h1>
                  <div>
                      Każdy kolejny poziom architekta zmniejsza ilość wymaganych surowców do rozbudowy budynków w mieście.


                  </div>
              </div>
                <div class="mainInfo">
                 <h1> Dane architekta</h1>
                    <div>
                        <div class="infoLine"> <div class="iconWork"><img src="https://cdn-icons.flaticon.com/png/512/1357/premium/1357714.png?token=exp=1640872388~hmac=00f74f1d1973069bb383b04b11b4cd12"></div>Aktualna zniżka na wymagane surowce do rozbudowy budynków:&nbsp-{{$bonus}}%</div>
