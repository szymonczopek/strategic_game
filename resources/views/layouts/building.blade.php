...
<div class="city">
    <div class="buildEnd">
        <div class="buildEndInfo">
            ...
            <div>@if($level>1)Trwa rozbudowa do poziomu {{$level}}@else Trwa budowa nowego budynku @endif</div>
            <div>Pozostalo {{(int)($buildEnd/3600)}}&nbsp h {{(int)(($buildEnd-(int)($buildEnd/3600))/60)}}minut </div>
